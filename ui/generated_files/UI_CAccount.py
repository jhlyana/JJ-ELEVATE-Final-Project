...
# Form implementation generated from reading ui file 'ui/raw_files/UI_CAccount.ui'
#
...
class Ui_CASHIER_ACCOUNT(object):
    def setupUi(self, CASHIER_ACCOUNT):
        ...
        CASHIER_ACCOUNT.resize(1914, 1002)
        CASHIER_ACCOUNT.setStyleSheet("background: white;")
        self.Owner_centralwidget = QtWidgets.QWidget(CASHIER_ACCOUNT)
        font = QtGui.QFont()
...
"")
        ...
        self.label_createUSER_profile_pic_cashier_4.setPixmap(QtGui.QPixmap(":/images/images/userProfilepicture.png"))
...
"")
        ...
        self.label_9.setGeometry(QtCore.QRect(0, 0, 111, 31))
        font = QtGui.QFont()
...
"")
        ...
        CASHIER_ACCOUNT.setCentralWidget(self.Owner_centralwidget)
        self.statusbar = QtWidgets.QStatusBar(CASHIER_ACCOUNT)
        self.statusbar.setObjectName("statusbar")
        CASHIER_ACCOUNT.setStatusBar(self.statusbar)
    ...
    def retranslateUi(self, CASHIER_ACCOUNT):
        ...
        CASHIER_ACCOUNT.setWindowTitle(_translate("CASHIER_ACCOUNT", "Inventory and Sales Management System"))
        self.timeLabel.setText(_translate("CASHIER_ACCOUNT", " 09 : 10 : 54 AM"))
        self.label_7.setText(_translate("CASHIER_ACCOUNT", "<html><head/><body><p align=\"center\"><span style=\" font-size:38pt; color:#022162;\">March 1, 2025</span><br/><span style=\" font-size:20pt; color:#b2423c;\">Monday</span></p></body></html>"))
        self.pushButton_CREATE_C.setText(_translate("CASHIER_ACCOUNT", "Create New Cashier Account"))
        self.pushButton_VIEW_C.setText(_translate("CASHIER_ACCOUNT", "View Cashier Account"))
        self.pushButton_ViewAcc.setText(_translate("CASHIER_ACCOUNT", "View Account"))
        self.ownerIDText.setText(_translate("CASHIER_ACCOUNT", "User ID"))
        self.ownerRoleText.setText(_translate("CASHIER_ACCOUNT", "User Role"))
        self.ownerNameText.setText(_translate("CASHIER_ACCOUNT", "Username"))
        self.pushButton_editDetailsOwner.setText(_translate("CASHIER_ACCOUNT", "Edit Details"))
        self.userNameText.setText(_translate("CASHIER_ACCOUNT", "Username"))
        self.oldPassText.setText(_translate("CASHIER_ACCOUNT", "Old Password"))
        self.setPassText.setText(_translate("CASHIER_ACCOUNT", "Set New Password"))
        self.pushButton_saveOwnerDetails.setText(_translate("CASHIER_ACCOUNT", "Save"))
        self.changeUserNameText.setText(_translate("CASHIER_ACCOUNT", "Change Username"))
        self.newUserNameText.setText(_translate("CASHIER_ACCOUNT", "New Username"))
        self.changeUserPassText.setText(_translate("CASHIER_ACCOUNT", "Change Password"))
        self.confirmPassText.setText(_translate("CASHIER_ACCOUNT", "Confirm New Password"))
        self.cashierIDText.setText(_translate("CASHIER_ACCOUNT", "User ID"))
        self.cashierRoleText.setText(_translate("CASHIER_ACCOUNT", "User Role"))
        self.cashierNameText.setText(_translate("CASHIER_ACCOUNT", "Username"))
        self.pushButton_editDetailsCashier.setText(_translate("CASHIER_ACCOUNT", "Edit Details"))
        self.userNameText_2.setText(_translate("CASHIER_ACCOUNT", "Username"))
        self.oldPassText_2.setText(_translate("CASHIER_ACCOUNT", "Old Password"))
        self.setPassText_2.setText(_translate("CASHIER_ACCOUNT", "Set New Password"))
        self.pushButton_saveCashierDetails.setText(_translate("CASHIER_ACCOUNT", "Save"))
        self.changeUserNameText_2.setText(_translate("CASHIER_ACCOUNT", "Change Username"))
        self.newUserNameText_2.setText(_translate("CASHIER_ACCOUNT", "New Username"))
        self.changeUserPassText_2.setText(_translate("CASHIER_ACCOUNT", "Change Password"))
        self.confirmPassText_2.setText(_translate("CASHIER_ACCOUNT", "Confirm New Password"))
        self.changeUserNameText_3.setText(_translate("CASHIER_ACCOUNT", "Create a New Cashier Account"))
        self.changeUserNameText_4.setText(_translate("CASHIER_ACCOUNT", "Shop ID"))
        self.changeUserNameText_5.setText(_translate("CASHIER_ACCOUNT", "User Role"))
        self.changeUserNameText_6.setText(_translate("CASHIER_ACCOUNT", "Username"))
        self.changeUserNameText_7.setText(_translate("CASHIER_ACCOUNT", "Password"))
        self.changeUserNameText_8.setText(_translate("CASHIER_ACCOUNT", "Confirm Password"))
        self.pushButton_saveAcc.setText(_translate("CASHIER_ACCOUNT", "Confirm"))
        self.pushButton_discardAcc.setText(_translate("CASHIER_ACCOUNT", "Discard"))
        self.label_9.setText(_translate("CASHIER_ACCOUNT", "CASHIER"))
        self.label.setText(_translate("CASHIER_ACCOUNT", "                                                                           J  &  J  ROOFSTEEL  AND  GUTTER  SUPPLY  (MOALBOAL BRANCH)     "))
        self.JJelevate_text.setText(_translate("CASHIER_ACCOUNT", "J & J ELEVATE"))
        self.pushButton_Dashboard_CASHIER.setText(_translate("CASHIER_ACCOUNT", " Dashboard   "))
        self.pushButton_Inventory_CASHIER.setText(_translate("CASHIER_ACCOUNT", "Inventory"))
        self.pushButton_Orders_CASHIER.setText(_translate("CASHIER_ACCOUNT", " Orders"))
        self.pushButton_Sales_CASHIER.setText(_translate("CASHIER_ACCOUNT", "  Sales"))
        self.pushButton_Account_CASHIER.setText(_translate("CASHIER_ACCOUNT", " Account     "))
        self.pushButton_LogOut_CASHIER.setText(_translate("CASHIER_ACCOUNT", "Log out"))
        self.pushButton_Stock_History_CASHIER.setText(_translate("CASHIER_ACCOUNT", "Stock History"))
