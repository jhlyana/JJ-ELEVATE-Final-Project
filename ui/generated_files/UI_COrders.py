...
# Form implementation generated from reading ui file 'UI_COrders.ui'
#
...
class Ui_CASHIER_ORDERS(object):
    def setupUi(self, CASHIER_ORDERS):
        ...
        self.Owner_centralwidget = QtWidgets.QWidget(CASHIER_ORDERS)
        font = QtGui.QFont()
...
"}")
        ...
        CASHIER_ORDERS.setCentralWidget(self.Owner_centralwidget)
        self.statusbar = QtWidgets.QStatusBar(CASHIER_ORDERS)
        self.statusbar.setObjectName("statusbar")
        CASHIER_ORDERS.setStatusBar(self.statusbar)
    ...
    def retranslateUi(self, CASHIER_ORDERS):
        ...
        CASHIER_ORDERS.setWindowTitle(_translate("CASHIER_ORDERS", "Inventory and Sales Management System"))
...
if __name__ == "__main__":
    ...
    CASHIER_ORDERS = QtWidgets.QMainWindow()
    ui = Ui_CASHIER_ORDERS()
    ui.setupUi(CASHIER_ORDERS)
    CASHIER_ORDERS.show()
    sys.exit(app.exec_())
