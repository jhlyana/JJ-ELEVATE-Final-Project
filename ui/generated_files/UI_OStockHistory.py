...
# Form implementation generated from reading ui file 'UI_OSTOCKHISTORY.ui'
#
...
class Ui_OWNER_STOCKHISTORY(object):
    def setupUi(self, OWNER_STOCKHISTORY):
        ...
        font = QtGui.QFont()
        font.setPointSize(4)
        OWNER_STOCKHISTORY.setFont(font)
        OWNER_STOCKHISTORY.setStyleSheet("background: white;")
        self.Owner_centralwidget = QtWidgets.QWidget(OWNER_STOCKHISTORY)
        font = QtGui.QFont()
...
"")
        ...
        OWNER_STOCKHISTORY.setCentralWidget(self.Owner_centralwidget)
        self.statusbar = QtWidgets.QStatusBar(OWNER_STOCKHISTORY)
        self.statusbar.setObjectName("statusbar")
        OWNER_STOCKHISTORY.setStatusBar(self.statusbar)
    ...
    def retranslateUi(self, OWNER_STOCKHISTORY):
        ...
        OWNER_STOCKHISTORY.setWindowTitle(_translate("OWNER_STOCKHISTORY", "Inventory and Sales Management System"))
        self.JJelevate_text.setText(_translate("OWNER_STOCKHISTORY", "J & J ELEVATE"))
        self.pushButton_Dashboard.setText(_translate("OWNER_STOCKHISTORY", " Dashboard   "))
        ...
        item.setText(_translate("OWNER_STOCKHISTORY", "Date       "))
...
if __name__ == "__main__":
    ...
    OWNER_STOCKHISTORY = QtWidgets.QMainWindow()
    ui = Ui_OWNER_STOCKHISTORY()
    ui.setupUi(OWNER_STOCKHISTORY)
    OWNER_STOCKHISTORY.show()
    sys.exit(app.exec_())
